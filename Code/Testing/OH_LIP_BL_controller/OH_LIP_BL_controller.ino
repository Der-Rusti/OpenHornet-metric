 ...
 ********************************************************************************************************************/
//RGB LEDs
  uint32_t IndYellow = LC_1.Color(255, 255, 0);   //Yellow Indicators
  uint32_t IndRed = LC_1.Color(255, 0, 0);        //Red Indicators
  uint32_t IndGreen = LC_1.Color(0, 255, 0);      //Green Indicators
...
//COLOUR: Change values here for Instrument panels backlight.
  uint32_t PanelGreen = LC_1.Color(0, 100 * brightness / 255, 0);  //Panel backlight colour
  uint32_t PanelGrren = LC_1.gamma32()
